...
MIN_BAR_GAP = 0
MAX_BAR_GAP = None
MIN_PRIMARY_LOGO_SIZE = 0
MAX_PRIMARY_LOGO_SIZE = None
...
class ChartConfig:
    ...
    value_text_opacity: float = 1.0
    time_label_text_color: str | None = None
    time_label_opacity: float = 0.22
    source_text_color: str | None = None
    source_text_opacity: float = 1.0
    rank_label_text_color: str | None = None
    rank_label_text_opacity: float = 1.0
