...
PATCHES=[
    {'file':'carlos_izaguirre.png','person':'Carlos Izaguirre','url':'https://commons.wikimedia.org/wiki/Special:Redirect/file/Argentina_equipo_1919.jpg?width=1000','page':'https://commons.wikimedia.org/wiki/File:Argentina_equipo_1919.jpg','source':'Argentina equipo 1919.jpg','license':'Public domain','crop':(0.57,0.43,0.82,1.0),'method':'Curated crop from Argentina 1919 team photo; Commons caption identifies Carlos Izaguirre fourth from left in front row.'},
    {'file':'jose_tognola.png','person':'José Tognola','url':'https://commons.wikimedia.org/wiki/Special:Redirect/file/Uruguay_1916.jpg?width=1000','page':'https://commons.wikimedia.org/wiki/File:Uruguay_1916.jpg','source':'Uruguay 1916.jpg','license':'Public domain','crop':(0.72,0.42,1.0,1.0),'method':'Curated crop from Uruguay 1916 team photo; Commons caption identifies José Tognola as the rightmost seated player.'},
    {'file':'tel_sforo_b_ez.png','person':'Telésforo Báez','url':'https://commons.wikimedia.org/wiki/Special:Redirect/file/Brazil_vs_chile_1919.jpg?width=1000','page':'https://commons.wikimedia.org/wiki/File:Brazil_vs_chile_1919.jpg','source':'Brazil vs chile 1919.jpg','license':'Public domain','crop':None,'method':'Historical match-photo fallback: Brazil v Chile, 11 May 1919; Telésforo Báez started for Chile. No reliable individual reusable portrait found.'},
]
...
def main():
    ...
    for idx,p in enumerate(PATCHES):
        ...
        if idx < len(PATCHES)-1: time.sleep(2.5)
